...
program			: ID
			{
			  ...
			  if ( strcmp(fileName, $1) )
				printf( "<Error> found in Line %d: program ID at the beginning is inconsistent with the file name\n", linenum );
			}
			  MK_SEMICOLON 
			  program_body
			  END ID
			{
			  if ( strcmp(fileName, $6) )
				printf( "<Error> found in Line %d: program ID at the end is inconsistent with the file name\n", linenum );
			  if ( strcmp($1, $6) )
				printf( "<Error> found in Line %d: program ID at the end is inconsistent with the beginning\n", linenum );
			  // dump symbol table
			  if( Opt_D == 1 )
...
func_decl		: ID MK_LPAREN opt_param_list
			...
			{
			  if ( strcmp($1, $11 ) )
				printf( "<Error> found in Line %d: function ID at the end is inconsistent with the beginnig\n", linenum );
			  funcReturn = 0;
			}
			;
